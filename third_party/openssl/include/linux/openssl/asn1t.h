/*
 * WARNING: do not edit!
 * Generated by Makefile from ../src/nssl-3.6.2-a98581e5a0.clean/include/openssl/asn1t.h.in
 *
 ...
 *              ... SEQUENCE components ...
 *      } ASN1_SEQUENCE_END(stname SEQUENCE. We can do:
 *
 *      ASN1_SEQUENCE(stname) = {
 *              ... SEQUENCE components ...
 *      } ASN1_SEQUENCE_END(stname)but a different
 *      name then use:
 *
