/*
 * WARNING: do not edit!
 * Generated by Makefile from ../src/nssl-3.6.2-a98581e5a0.clean/include/openssl/ocsp.h.in
 *
...
#define sk_OCSP_SINGLERESP_set_cmp_func(sk, cmp) ((sk_OCSP_SINGLERESP_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OCSP_SINGLERESP_sk_type(sk), ossl_chOCSP_SINGLERESP_freefunc_type(freefunc)))
