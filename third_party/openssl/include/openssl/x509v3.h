/*
 * WARNING: do not edit!
 * Generated by Makefile from ../src/nssl-3.6.2-a98581e5a0.clean/include/openssl/x509v3.h.in
 *
...
#define sk_GENERAL_NAMES_new(cmp) ((STACK_OF(GENERAL_NAMESNSSL_sk_num(ossl_check_const_GENERAL_NAMES_sk_type(sk))
#define sk_GENERAL_NAMES_value(sk, idx) ((GENERAL_NAMES *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAMES_sk_type(sk), (idx)))
